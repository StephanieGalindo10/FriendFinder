...
function createQuestions() {
	let q1 = "I like meeting new people.";
	let q2 = "I am very determine in my goals.";
	let q3 = "I am like to have fun in the city.";
	let q4 = "I perfer to stay at home.";
	let q5 = "I enjoy watching televison al day.";
	let q6 = "I can often get along with others.";
	let q7 = "I like to going out and trying new foods.";
	let q8 = "I like being creative and draw in my spare time.";
	let q9 = "I often daydream and focus to much on my problems.";
	let q10 = "I can focus on my goal even under pressure.";
